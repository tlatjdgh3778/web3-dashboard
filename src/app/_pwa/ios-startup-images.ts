// app/_pwa/ios-startup-images.ts
...
export function generateIOSStartupImages() {
	const images: IOSImage[] = [
		{
		...
		{
			file: "iPhone_17_Pro__iPhone_17__iPhone_16_Pro_landscape.png",
			media:
		...
		{
			file: "iPhone_14_Plus__iPhone_13_Pro_Max__iPhone_12_Pro_Max_landscape.png",
			media:
	...
	images.forEach((img, index) => {
		// name 속성은 key 축약 버전
		result[`apple-touch-startup-image-${index}`] = JSON.stringify({
			media: img.media,
			href: `/splash_screens/${img.file}`,
		});
	});
